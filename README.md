...
For each application, tool, etc. that is used in the stack there is a folder.

In each folder reside the config files for said piece of the stack, already organized and structured so you only have to copy the contents of the folder and paste them in the home directory.

***This isn't the most elegant way to do it. I may have to change this in the future.***